...
gdjs.Connectivity_45testCode.GDFilesObjects1= [];
gdjs.Connectivity_45testCode.GDFilesObjects2= [];


gdjs.Connectivity_45testCode.asyncCallback13221500 = function (runtimeScene, asyncObjectsList) {
...
gdjs.Connectivity_45testCode.idToCallbackMap.set(13221500, gdjs.Connectivity_45testCode.asyncCallback13221500);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.21), (runtimeScene) => (gdjs.Connectivity_45testCode.asyncCallback13221500(runtimeScene, asyncObjectsList)), 13221500, asyncObjectsList);
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13220532);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13222668);
}
}
if (isConditionTrue_0) {
...
gdjs.Connectivity_45testCode.GDFilesObjects1.length = 0;
gdjs.Connectivity_45testCode.GDFilesObjects2.length = 0;
